...
class ResturantRegistertionBloc extends Object
    with ResturantRegisterValdiator
    implements BlocBase {
  ...
  final _games = BehaviorSubject<List<int>>();
////
//////////////////////////////sink(input)///////////////////////////////////////
  ...
  Function(List<int>) get changeGames => _games.sink.add;

///////////////////////////stream(output)////////////////////////////////////////
  Stream<String> get resturantNameStream =>
      _resturantName.stream.transform(valdiator);
  ...
  Stream<String> get openTimeStream =>
      _opentime.stream.transform(timeValdiator);
  Stream<String> get closeTimeStream =>
      _closetime.stream.transform(timeValdiator);
  ...
  Stream<List<int>> get gamesStream => _games.stream;

  Stream<bool> get submitRegisterStream => _registerPressed.stream.transform(
        ...
        List<int> lastGames = await gamesStream.first;
        var restaurant = await RestaurantRepository().add(
          lastResturantName,
          lastAddress,
          lastCity,
          lastStreet,
